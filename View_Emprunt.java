...
public class View_Emprunt {
	...
	private void initialize() {
		...
		lblNewLabel_message.setBounds(49, 73, 362, 14);
		...
		btnNewButton.setBounds(6, 12, 168, 23);
				...
				else
				{
					...
					else
					{
						try {
							...
							lblNewLabel_message.setText("Livre emprunt� ! vous pouvez saisir un autre ISBN");
							mainMVC.getM().getall();
